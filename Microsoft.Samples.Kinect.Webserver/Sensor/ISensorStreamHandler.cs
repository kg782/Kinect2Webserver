...
namespace Microsoft.Samples.Kinect.Webserver.Sensor
{
    ...
    public interface ISensorStreamHandler
    {
        ...
        /// </param>
        void ProcessColor(byte[] colorData, ColorFrame colorFrame);
        ...
        /// </param>
        void ProcessDepth(KinectBuffer depthData, DepthFrame depthFrame);
        ...
        /// </param>
        void ProcessBody(Body[] bodies, BodyFrame bodyFrame);
