...
namespace Microsoft.Samples.Kinect.Webserver.Sensor
{
    ...
    internal class UserActivityRecord
    {
        ...
        public UserActivityRecord(CameraSpacePoint position, int updateId, long timestamp)
        {
        ...
        /// </summary>
        public CameraSpacePoint LastPosition { get; private set; }

        public void Update(CameraSpacePoint position, int updateId, long timestamp)
        {
            ...
            var delta = new CameraSpacePoint
            {
