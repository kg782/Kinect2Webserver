...
var Kinect = (function () {
    ...
    function KinectConnector() {
        ...
        function KinectSensor(baseEndpointUri, onconnection) {
            ...
            //     .setHitTestHandler( [handler(bodyTrackingId, handType, x, y)] )] )
            //
            ...
            //          - bodyTrackingId: The body tracking ID for which interaction
        ...
        this.SKELETON_STREAM_NAME = "body";
...
var KinectUI = (function () {
    ...
    function KinectUIAdapter() {
        ...
        //
        // trackingId: The body tracking ID for which interaction information is
        //             being retrieved.
