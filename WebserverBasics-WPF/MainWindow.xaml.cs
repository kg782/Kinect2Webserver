...
namespace Microsoft.Samples.Kinect.WebserverBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// </summary>
        private const string SamplePageName = "index.html";
        ...
        public MainWindow()
        {
            ...
            try
            {
                ...
                Debug.WriteLine("OriginUri: " + Properties.Settings.Default.OriginUri.Trim());
            }
            ...
            this.webserver.SensorStreamHandlerFactories.Add(new GestureStreamHandlerFactory());
